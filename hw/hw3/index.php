...
<html>
    ...
    <div class="logo">
        ...
        <form action="confirmation.php" method="post">
            ...
            <div class="questions">
                <input type="radio" label="item1" name="gpuChoice" value="Graphics Processing Unit"/>
                    <label for="item1">Graphics Processing Unit</label> <br>
                <input type="radio" lable="item2" name="gpuChoice" value="Graphics Production Unit"/>
            ...
            <div class="questions">
                <input type="checkbox" label="lang1" name="lang[]" value="Java">
                    <label for="lang1"> Java </label> <br>
                <input type="checkbox" label="lang2" name="lang[]" value="Viper">
                    <label for="lang2"> Viper </label> <br>
                <input type="checkbox" label="lang3" name="lang[]" value="C++">
                    <label for="lang3"> C++ </label> <br>
                <input type="checkbox" label="lang4" name="lang[]" value="Python">
                    <label for="lang4"> Python </label> <br>
                <input type="checkbox" label="lang5" name="lang[]" value="Diamond">
            ...
            <h3>3. Which of these is a typical CPU clock speed?</h3>
             <div class="questions">
                <input type="radio" label="clock1" name="cpuChoice" value="4 kHz"/>
                    <label for="clock1">4 KHz</label> <br>
                <input type="radio" lable="clock2" name="cpuChoice" value="4 MHz"/>
                    <label for="clock2">4 MHz</label> <br>
                <input type="radio" lable="clock3" name="cpuChoice" value="4 GHz"/>
                    <label for="clock3">4 GHz</label> <br>
                <input type="radio" lable="clock4" name="cpuChoice" value="4 THz"/>
            ...
            <h3>4. Can an HDMI cable display a refresh rate above 60Hz?</h3>
             <div class="questions">
                <input type="radio" label="hdmi1" name="hdmiChoice" value="Yes"/>
                    <label for="hdmi1">Yes</label> <br>
                <input type="radio" label="hdmi2" name="hdmiChoice" value="No"/>
